...
- IMPORTANT: When generating PDF reports that include creatives, ALWAYS pass the image URLs via the imageUrls parameter. If you generated creatives earlier in the conversation (via generate_ad_creative_with_text or generate_ad_images), collect their URLs and pass them as comma-separated imageUrls to generate_pdf_report. This embeds the actual creative images in the PDF.
